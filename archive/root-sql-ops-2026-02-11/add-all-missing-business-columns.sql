-- Add all missing columns to the businesses table in proper order

-- First, add the basic columns that other columns depend on
...
-- Then add the other missing columns
