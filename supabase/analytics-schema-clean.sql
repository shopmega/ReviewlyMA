-- Analytics and Monitoring Schema for Avis Platform (CLEAN VERSION)
...
CREATE INDEX IF NOT EXISTS idx_business_analytics_business_date ON business_analytics(business_id, analytics_date DESC);
CREATE INDEX IF NOT EXISTS idx_business_analytics_date ON business_analytics(analytics_date DESC);
...
RETURNS TRIGGER AS $$
BEGIN
    INSERT INTO business_analytics (business_id, analytics_date, views)
