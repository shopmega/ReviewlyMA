    ...
    <div className={`space-y-4 ${className}`}>
      <div className="flex items-center gap-2 mb-4">
        <Badge variant="secondary" className="bg-orange-100 text-orange-800">
          {t('sponsored.badge', 'Annonces sponsorisees')}
        </Badge>
        <span className="text-sm text-muted-foreground">
          {t('sponsored.subtitle', 'Resultats sponsorises par les entreprises')}
        </span>
      </div>
                    ...
                    {business.hours && business.hours.length > 0 && (
                      <div className="flex items-center gap-1 mt-2">
                        ...
                        <span className="text-xs text-muted-foreground">
                          {business.hours[0].isOpen ? t('sponsored.open', 'Ouvert') : t('sponsored.closed', 'Ferme')} - {business.hours[0].open}-{business.hours[0].close}
                        </span>
                      </div>
                    )}
                  </div>
