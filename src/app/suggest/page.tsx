      ...
      <div className="container max-w-2xl mx-auto space-y-8">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          <div className="bg-card p-4 rounded-xl border border-border shadow-none flex flex-col items-center text-center">
            ...
            <span className="font-semibold text-sm text-foreground">Contribution directe</span>
          ...
          <CardContent>
            <form action={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <Input id="name" name="name" placeholder="Ex: TechCorp Solutions" required />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="address" name="address" placeholder="Ex: 123 Bd Zerktouni" />
              </div>
