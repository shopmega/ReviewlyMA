        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl space-y-6">
            <div className="flex items-center gap-3">
              ...
              <Badge variant="outline" className="border-blue-200 text-blue-700 bg-blue-50 text-sm uppercase tracking-wider font-bold">
                Nouveautes
              </Badge>
            </div>
            <h1 className="text-5xl md:text-7xl font-bold font-headline tracking-tight">
              Derniers <span className="text-blue-600">Arrives</span>
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Explorez les nouvelles adresses qui viennent de rejoindre la communaute. Donnez votre avis parmi les premiers et aidez ces
              entreprises a se faire connaitre.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between mb-12">
          ...
          <div className="hidden md:flex items-center gap-4 text-sm text-muted-foreground">
            <span className="flex items-center gap-1">
              <Calendar className="w-4 h-4 text-blue-500" /> Trie par date
            </span>
            <span>•</span>
            <span>{businesses.length} resultats</span>
          </div>
        </div>
