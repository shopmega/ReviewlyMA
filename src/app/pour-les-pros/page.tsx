    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-headline font-bold tracking-tight text-foreground">
              Propulsez votre <span className="text-info">Entreprise</span> avec {siteName}
            </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="space-y-1">
              ...
              <div className="text-muted-foreground text-sm font-medium">Entreprises inscrites</div>
            </div>
            <div className="space-y-1">
              <div className="text-3xl font-bold text-white tracking-tight">500k+</div>
              <div className="text-muted-foreground text-sm font-medium">Avis authentiques</div>
            </div>
            <div className="space-y-1">
              <div className="text-3xl font-bold text-white tracking-tight">2.5M</div>
              <div className="text-muted-foreground text-sm font-medium">Vues mensuelles</div>
            </div>
            <div className="space-y-1">
              <div className="text-3xl font-bold text-white tracking-tight">150+</div>
              <div className="text-muted-foreground text-sm font-medium">Villes couvertes</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-20 space-y-4">
            <h2 className="text-3xl md:text-5xl font-headline font-bold text-foreground tracking-tight">
              Choisissez votre <span className="text-info">Plan</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl mx-auto">
            ...
            <div className="bg-card p-10 rounded-3xl border border-border space-y-8">
              <div className="space-y-4">
                <Badge className="bg-secondary text-secondary-foreground border-none py-1 px-3">GRATUIT</Badge>
                <h3 className="text-3xl font-bold font-headline">Basic</h3>
                <p className="text-muted-foreground text-sm">Indispensable pour démarrer votre transition numérique.</p>
              </div>
            ...
            <div className="bg-card p-8 rounded-2xl border border-warning/30 space-y-6 shadow-none relative overflow-hidden group h-full flex flex-col">
              ...
              <div className="space-y-3 flex-grow">
                <Badge className="bg-warning text-warning-foreground border-none py-1 px-3">POPULAIRE</Badge>
                <h3 className="text-2xl font-bold font-headline">Business Growth</h3>
                <p className="text-muted-foreground text-sm">Parfait pour booster votre visibilité.</p>
              </div>
              <div className="text-center py-3 bg-secondary/20 rounded-md border border-border my-4">
                ...
                <div className="text-xs font-bold text-muted-foreground mt-1">ou {growthMonthly} MAD/mois</div>
              </div>
            ...
            <div className="bg-card p-8 rounded-2xl border border-info/20 space-y-6 shadow-none relative overflow-hidden group h-full flex flex-col">
              ...
              <div className="space-y-3 flex-grow">
                ...
                <p className="text-muted-foreground text-sm">Le pack complet: benchmark salarial, reporting et acquisition.</p>
              </div>
              <div className="text-center py-3 bg-secondary/20 rounded-md border border-border my-4">
                <div className="text-3xl font-black text-white">{goldAnnual} MAD <span className="text-base font-medium opacity-70">/ an</span></div>
                <div className="text-xs font-bold text-muted-foreground mt-1">ou {goldMonthly} MAD/mois</div>
              </div>
              <ul className="space-y-3 flex-grow">
      ...
      <section id="premium" className="py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 space-y-4">
            <Badge variant="outline" className="border-info/20 bg-info/10 text-info px-4 py-1">AVANTAGES PREMIUM</Badge>
            <h2 className="text-3xl md:text-5xl font-headline font-bold text-foreground tracking-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card className="border-border bg-card shadow-none rounded-2xl overflow-hidden hover:bg-secondary/20 transition-colors">
              <CardHeader className="pb-6">
                ...
                <div className="text-2xl font-black text-foreground">1 Entreprise</div>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="pt-6 border-t border-border">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-foreground">Gratuit</div>
                    <p className="text-sm text-muted-foreground">Inclus avec votre compte</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-info/20 bg-card shadow-none rounded-2xl overflow-hidden relative">
              ...
              <CardHeader className="pb-6">
                ...
                <div className="text-2xl font-black text-foreground">Jusqu'à 5 Entreprises</div>
              </CardHeader>
              <CardContent className="space-y-6">
                <ul className="space-y-4">
                ...
                <div className="pt-6 border-t border-border">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-info">{goldAnnual} MAD / an</div>
                    <p className="text-sm text-muted-foreground">Pour toutes vos entreprises</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-8">
                ...
                <div className="grid grid-cols-3 gap-4 text-sm font-bold">
                  <div className="text-center p-4 bg-card rounded-md border border-border shadow-none">
                    ...
                    <div className="text-muted-foreground text-[10px] uppercase tracking-wider">Entreprises</div>
                  </div>
                  <div className="text-center p-4 bg-card rounded-md border border-border shadow-none">
                    <div className="text-2xl font-black text-success">100%</div>
                    <div className="text-muted-foreground text-[10px] uppercase tracking-wider">Unifié</div>
                  </div>
                  <div className="text-center p-4 bg-card rounded-md border border-border shadow-none">
                    <div className="text-2xl font-black text-warning">24/7</div>
                    <div className="text-muted-foreground text-[10px] uppercase tracking-wider">Prioritaire</div>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center border-border bg-secondary/20 rounded-2xl p-6 hover:bg-secondary/30 transition-colors">
              <CardHeader>
                <div className="mx-auto bg-card text-info rounded-md border border-border shadow-none w-16 h-16 flex items-center justify-center mb-4 text-2xl font-black italic">
                  1
                </div>
                <CardTitle className="text-xl font-bold text-foreground">Effectuez le paiement</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="text-center border-border bg-secondary/20 rounded-2xl p-6 hover:bg-secondary/30 transition-colors">
              <CardHeader>
                ...
                <CardTitle className="text-xl font-bold text-foreground">Envoyez la preuve</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground font-medium leading-relaxed">
            ...
            <Card className="text-center border-border bg-secondary/20 rounded-2xl p-6 hover:bg-secondary/30 transition-colors">
              <CardHeader>
                <div className="mx-auto bg-info text-white rounded-md shadow-none w-16 h-16 flex items-center justify-center mb-4 text-2xl font-black italic">
                  3
                </div>
                <CardTitle className="text-xl font-bold text-foreground">Activez Premium</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground font-medium leading-relaxed">
      ...
      <section className="py-32 bg-card text-foreground overflow-hidden relative border-t border-border">
        ...
        <div className="container mx-auto px-4 text-center space-y-10 relative z-10">
          ...
          <p className="text-muted-foreground font-medium">Rejoignez les entreprises qui transforment leur attractivité en succès.</p>
        </div>
      </section>
    </div>
  );
